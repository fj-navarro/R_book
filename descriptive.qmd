...
-   the **distribution**: can be a normal distribution, binomial distribution, and other distributions like Bernoulli distribution.
-   the **central tendency**: can be the mean, median, and mode of the data.
-   the **dispersion of the data**: it describes the spread of the data, and dispersion can be the variance, standard deviation, and interquartile range.
