...
Figure 10 shows the complete set of Boolean operations and how they work:
![](/img/Picture10.png)
Figure 10. The complete set of Boolean operations. x is the left-hand circle, y is the right-hand circle, and the shaded regions show which parts each operator selects
